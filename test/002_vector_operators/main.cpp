...
int main()
{
    // vector assign
    {
        ...
        ASSERT_MSG(v3d == Vector3D(static_cast<F64>(5.5f), static_cast<F64>(6.6f), static_cast<F64>(7.7f)) &&
                   v3f2 == Vector3F(5.5f, 6.6f, 7.7f), "assign failed");
    ...
    // vector access
    {
        ...
        ASSERT_MSG(almostEqual(v4d[0], 1.1) && almostEqual(v4d[1], 2.2) && almostEqual(v4d[2], 3.3) &&
                   almostEqual(v4d[3], 4.4), "access filed");
    ...
    // vector math-4,5,6
    {
        ...
        ASSERT_MSG(v4d == Vector4D(1.0, 1.1, 1.2, 1.3) && almostEqual(v4d2,
                                                                      Vector4D(2.1666666666666665, 2.1200000000000001,
                                                                               2.076923076923076, 2.037037037037037),
                                                                      1), "math-4 failed");
        ASSERT_MSG(v3f == Vector3F(1.0f, 1.1f, 1.2f) &&
                   v3f2 == Vector3F(11.90000057220459, 11.118182182312012, 10.466666221618652), "math-5 failed");
