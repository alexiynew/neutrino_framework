...
int main()
{
    ...
    assert_msg(m34[0] == vec4f(1, 0, 0, 0) && m34[1] == vec4f(0, 1, 0, 0) && m34[2] == vec4f(0, 0, 1, 0), "matrix 34f access failed");
    ...
    assert_msg(m33[0] == vec3f(1, 0, 0) && m33[1] == vec3f(0, 1, 0) && m33[2] == vec3f(0, 0, 1), "matrix 3f access failed");
    assert_msg(m23[0] == vec3f(1, 0, 0) && m23[1] == vec3f(0, 1, 0), "matrix 23f access failed");

    assert_msg(m42[0] == vec2f(1, 0) && m42[1] == vec2f(0, 1) && m42[2] == vec2f(0, 0) && m42[3] == vec2f(0, 0), "matrix 42f access failed");
    ...
    assert_msg(m44.column(0) == vec4f(1, 0, 0, 0) && m44.column(1) == vec4f(0, 1, 0, 0) && m44.column(2) == vec4f(0, 0, 1, 0) && m44.column(3) == vec4f(0, 0, 0, 1), "matrix 4f access failed");
    ...
    assert_msg(m43.column(0) == vec3f(1, 0, 0) && m43.column(1) == vec3f(0, 1, 0) && m43.column(2) == vec3f(0, 0, 1) && m43.column(3) == vec3f(0, 0, 0), "matrix 43f access failed");
    ...
    assert_msg(m32.column(0) == vec2f(1, 0) && m32.column(1) == vec2f(0, 1) && m32.column(2) == vec2f(0, 0), "matrix 32f access failed");
    assert_msg(m22.column(0) == vec2f(1, 0) && m22.column(1) == vec2f(0, 1), "matrix 2f access failed");


    assert_msg(m44.row(0) == vec4f(1, 0, 0, 0) && m44.row(1) == vec4f(0, 1, 0, 0) && m44.row(2) == vec4f(0, 0, 1, 0) && m44.row(3) == vec4f(0, 0, 0, 1), "matrix 4f access failed");
    ...
    assert_msg(m33.row(0) == vec3f(1, 0, 0) && m33.row(1) == vec3f(0, 1, 0) && m33.row(2) == vec3f(0, 0, 1), "matrix 33f access failed");
    assert_msg(m23.row(0) == vec2f(1, 0) && m23.row(1) == vec2f(0, 1) && m23.row(2) == vec2f(0, 0), "matrix 23f access failed");
