...
int main()
{
    ...
    ASSERT_MSG(m44[0] == Vector4F(1, 0, 0, 0) && m44[1] == Vector4F(0, 1, 0, 0) && m44[2] == Vector4F(0, 0, 1, 0) &&
               m44[3] == Vector4F(0, 0, 0, 1), "matrix 4f access failed");
    ...
    ASSERT_MSG(m43[0] == Vector3F(1, 0, 0) && m43[1] == Vector3F(0, 1, 0) && m43[2] == Vector3F(0, 0, 1) &&
               m43[3] == Vector3F(0, 0, 0), "matrix 43f access failed");
    ...
    ASSERT_MSG(m42[0] == Vector2F(1, 0) && m42[1] == Vector2F(0, 1) && m42[2] == Vector2F(0, 0) &&
               m42[3] == Vector2F(0, 0), "matrix 42f access failed");
    ...
    ASSERT_MSG(m34.column(0) == Vector4F(1, 0, 0, 0) && m34.column(1) == Vector4F(0, 1, 0, 0) &&
               m34.column(2) == Vector4F(0, 0, 1, 0), "matrix 34f access failed");
    ...
    ASSERT_MSG(m33.column(0) == Vector3F(1, 0, 0) && m33.column(1) == Vector3F(0, 1, 0) &&
               m33.column(2) == Vector3F(0, 0, 1), "matrix 3f access failed");
    ...
    ASSERT_MSG(m42.column(0) == Vector2F(1, 0) && m42.column(1) == Vector2F(0, 1) && m42.column(2) == Vector2F(0, 0) &&
               m42.column(3) == Vector2F(0, 0), "matrix 42f access failed");
    ...
    ASSERT_MSG(m34.row(0) == Vector3F(1, 0, 0) && m34.row(1) == Vector3F(0, 1, 0) && m34.row(2) == Vector3F(0, 0, 1) &&
               m34.row(3) == Vector3F(0, 0, 0), "matrix 34f access failed");
    ASSERT_MSG(m24.row(0) == Vector2F(1, 0) && m24.row(1) == Vector2F(0, 1) && m24.row(2) == Vector2F(0, 0) &&
               m24.row(3) == Vector2F(0, 0), "matrix 24f access failed");

    ASSERT_MSG(m43.row(0) == Vector4F(1, 0, 0, 0) && m43.row(1) == Vector4F(0, 1, 0, 0) &&
               m43.row(2) == Vector4F(0, 0, 1, 0), "matrix 43f access failed");
