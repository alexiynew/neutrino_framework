...
int main()
{
    ...
    // vector geometric functions
    {
        ...
        ASSERT_MSG(almostEqual(distance(Vector3F(3.0f, 3.0f, 5.0f), Vector3F(2.0f, 1.0f, 2.0f)), length(v3f)) && almostEqual(distance(Vector3F(2.0f, 1.0f, 2.0f), Vector3F(3.0f, 3.0f, 5.0f)), length(v3f)), "distance failed");
