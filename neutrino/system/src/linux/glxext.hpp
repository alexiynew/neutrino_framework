#ifndef SYSTEM_SRC_LINUX_GLXEXT_HPP
#define SYSTEM_SRC_LINUX_GLXEXT_HPP
...
inline const char* const GLX_EXTENSION_NAME = "GLX";
constexpr int GLX_PbufferClobber            = 0;
constexpr int GLX_BufferSwapComplete        = 1;
constexpr int __GLX_NUMBER_EVENTS           = 17;
constexpr int GLX_BAD_SCREEN                = 1;
constexpr int GLX_BAD_ATTRIBUTE             = 2;
constexpr int GLX_NO_EXTENSION              = 3;
constexpr int GLX_BAD_VISUAL                = 4;
constexpr int GLX_BAD_CONTEXT               = 5;
constexpr int GLX_BAD_VALUE                 = 6;
constexpr int GLX_BAD_ENUM                  = 7;
...
constexpr int GLX_VENDOR     = 0x1;
constexpr int GLX_VERSION    = 0x2;
constexpr int GLX_EXTENSIONS = 0x3;
...
constexpr int GLX_PIXMAP_BIT              = 0x00000002;
constexpr int GLX_PBUFFER_BIT             = 0x00000004;
constexpr int GLX_RGBA_BIT                = 0x00000001;
constexpr int GLX_COLOR_INDEX_BIT         = 0x00000002;
constexpr int GLX_PBUFFER_CLOBBER_MASK    = 0x08000000;
constexpr int GLX_FRONT_LEFT_BUFFER_BIT   = 0x00000001;
constexpr int GLX_FRONT_RIGHT_BUFFER_BIT  = 0x00000002;
constexpr int GLX_BACK_LEFT_BUFFER_BIT    = 0x00000004;
constexpr int GLX_BACK_RIGHT_BUFFER_BIT   = 0x00000008;
constexpr int GLX_AUX_BUFFERS_BIT         = 0x00000010;
constexpr int GLX_DEPTH_BUFFER_BIT        = 0x00000020;
constexpr int GLX_STENCIL_BUFFER_BIT      = 0x00000040;
constexpr int GLX_ACCUM_BUFFER_BIT        = 0x00000080;
...
constexpr int GLX_DONT_CARE               = int(0xFFFFFFFF);
constexpr int GLX_NONE                    = 0x8000;
constexpr int GLX_SLOW_CONFIG             = 0x8001;
constexpr int GLX_TRUE_COLOR              = 0x8002;
constexpr int GLX_DIRECT_COLOR            = 0x8003;
constexpr int GLX_PSEUDO_COLOR            = 0x8004;
constexpr int GLX_STATIC_COLOR            = 0x8005;
constexpr int GLX_GRAY_SCALE              = 0x8006;
constexpr int GLX_STATIC_GRAY             = 0x8007;
constexpr int GLX_TRANSPARENT_RGB         = 0x8008;
constexpr int GLX_TRANSPARENT_INDEX       = 0x8009;
constexpr int GLX_VISUAL_ID               = 0x800B;
constexpr int GLX_SCREEN                  = 0x800C;
constexpr int GLX_NON_CONFORMANT_CONFIG   = 0x800D;
...
constexpr int GLX_COLOR_INDEX_TYPE        = 0x8015;
...
constexpr int GLX_PRESERVED_CONTENTS      = 0x801B;
constexpr int GLX_LARGEST_PBUFFER         = 0x801C;
constexpr int GLX_WIDTH                   = 0x801D;
constexpr int GLX_HEIGHT                  = 0x801E;
constexpr int GLX_EVENT_MASK              = 0x801F;
constexpr int GLX_DAMAGED                 = 0x8020;
constexpr int GLX_SAVED                   = 0x8021;
constexpr int GLX_WINDOW                  = 0x8022;
constexpr int GLX_PBUFFER                 = 0x8023;
constexpr int GLX_PBUFFER_HEIGHT          = 0x8040;
constexpr int GLX_PBUFFER_WIDTH           = 0x8041;
