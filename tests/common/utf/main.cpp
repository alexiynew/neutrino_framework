...
public:
        ...
        : Suite("UtfTest")
    {
        ...
        add_test([this]() { widechar_to_utf8(); }, "widechar_to_utf8");

        add_test([this]() { utf8_to_utf16(); }, "utf8_to_utf16");
        add_test([this]() { utf32_to_utf16(); }, "utf32_to_utf16");
        add_test([this]() { widechar_to_utf16(); }, "widechar_to_utf16");

        add_test([this]() { utf8_to_utf32(); }, "utf8_to_utf32");
        add_test([this]() { utf16_to_utf32(); }, "utf16_to_utf32");
        add_test([this]() { widechar_to_utf32(); }, "widechar_to_utf32");

        add_test([this]() { utf8_to_widechar(); }, "utf8_to_widechar");
        add_test([this]() { utf16_to_widechar(); }, "utf16_to_widechar");
        add_test([this]() { utf32_to_widechar(); }, "utf32_to_widechar");
...
private:
    ...
    void widechar_to_utf8()
    {
        ...
        const std::wstring wide_3(L"\u7cc2\u7cc3\u7cc4");
        const std::wstring wide_4(L"\ud7f8\ud7f9\ud7fa\ud7fb");
        ...
        TEST_ASSERT(utf::to_utf8(wide_3) == utf8_3, "Convertation failed.");
        TEST_ASSERT(utf::to_utf8(wide_4) == utf8_4, "Convertation failed.");
        TEST_ASSERT(utf::to_utf8(wide_5) == utf8_5, "Convertation failed.");
        TEST_ASSERT(utf::to_utf8(wide_6) == utf8_6, "Convertation failed.");
    ...
    void widechar_to_utf16()
    {
        ...
        TEST_ASSERT(utf::to_utf16(wide_1) == utf16_1, "Convertation failed.");
        TEST_ASSERT(utf::to_utf16(wide_2) == utf16_2, "Convertation failed.");
        TEST_ASSERT(utf::to_utf16(wide_3) == utf16_3, "Convertation failed.");
        TEST_ASSERT(utf::to_utf16(wide_4) == utf16_4, "Convertation failed.");
        TEST_ASSERT(utf::to_utf16(wide_5) == utf16_5, "Convertation failed.");
        TEST_ASSERT(utf::to_utf16(wide_6) == utf16_6, "Convertation failed.");
    ...
    void widechar_to_utf32()
    {
        ...
        TEST_ASSERT(utf::to_utf32(wide_1) == utf32_1, "Convertation failed.");
        TEST_ASSERT(utf::to_utf32(wide_2) == utf32_2, "Convertation failed.");
        TEST_ASSERT(utf::to_utf32(wide_3) == utf32_3, "Convertation failed.");
        TEST_ASSERT(utf::to_utf32(wide_4) == utf32_4, "Convertation failed.");
        TEST_ASSERT(utf::to_utf32(wide_5) == utf32_5, "Convertation failed.");
        TEST_ASSERT(utf::to_utf32(wide_6) == utf32_6, "Convertation failed.");
    ...
    void utf8_to_widechar()
    {
        ...
        TEST_ASSERT(utf::to_wstring(utf8_1) == wide_1, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf8_2) == wide_2, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf8_3) == wide_3, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf8_4) == wide_4, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf8_5) == wide_5, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf8_6) == wide_6, "Convertation failed.");

        // TODO: Add tests with broken codepoints
    }

    void utf16_to_widechar()
    {
        const std::u16string utf16_1(u"abcdefghijklopqrstyvwxyz1234567890-=!@#$%^&*()_+{}|[]\\;':\",./<>?`~");
        const std::u16string utf16_2(u"\u00a3\u00a4\u00a5");
        const std::u16string utf16_3(u"\u7cc2\u7cc3\u7cc4");
        ...
        TEST_ASSERT(utf::to_wstring(utf16_1) == wide_1, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf16_2) == wide_2, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf16_3) == wide_3, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf16_4) == wide_4, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf16_5) == wide_5, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf16_6) == wide_6, "Convertation failed.");

        // TODO: Add tests with broken codepoints
    }

    void utf32_to_widechar()
    {
        const std::u32string utf32_1(U"abcdefghijklopqrstyvwxyz1234567890-=!@#$%^&*()_+{}|[]\\;':\",./<>?`~");
        const std::u32string utf32_2(U"\u00a3\u00a4\u00a5");
        const std::u32string utf32_3(U"\u7cc2\u7cc3\u7cc4");
        ...
        TEST_ASSERT(utf::to_wstring(utf32_1) == wide_1, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf32_2) == wide_2, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf32_3) == wide_3, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf32_4) == wide_4, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf32_5) == wide_5, "Convertation failed.");
        TEST_ASSERT(utf::to_wstring(utf32_6) == wide_6, "Convertation failed.");
    ...
    void widechar_to_codepoints()
    {
        ...
        TEST_ASSERT(utf::to_codepoints(wide_1) == cp_1, "Convertion to codepoints failed.");
        TEST_ASSERT(utf::to_codepoints(wide_2) == cp_2, "Convertion to codepoints failed.");
        TEST_ASSERT(utf::to_codepoints(wide_3) == cp_3, "Convertion to codepoints failed.");
        TEST_ASSERT(utf::to_codepoints(wide_4) == cp_4, "Convertion to codepoints failed.");
        TEST_ASSERT(utf::to_codepoints(wide_5) == cp_5, "Convertion to codepoints failed.");
        TEST_ASSERT(utf::to_codepoints(wide_6) == cp_6, "Convertion to codepoints failed.");
    }
};
